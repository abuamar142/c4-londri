dynamic cMobile {
    ...
    comBackendAuthentication -> comDatabaseAuth "Store employee data in the database"
    comBackendAuthentication -> comDatabaseUsers "Store employee data in the database"
